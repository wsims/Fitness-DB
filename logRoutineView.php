...
<div id="contentWrapper">
	...
	// change the value of $dbuser and $dbpass to your username and password
		...
		$query = "SELECT Exercise.name, defaultSets, defaultReps, logRoutineExercise.weight
FROM Exercise, routineExercise, Routine , logRoutineExercise
WHERE Exercise.exerciseID = routineExercise.exerciseID 
AND Routine.routineID = routineExercise.routineID
AND Routine.routineID = $id AND Routine.routineID = logRoutineExercise.logRoutineID And Exercise.exerciseID = logRoutineExercise.routineExerciseID" ;
